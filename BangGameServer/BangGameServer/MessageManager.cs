...
namespace BangGameServer
{
    public static class MessageManager
    {
        ...
        public static byte[] MakeByteMessage(Header header, int index, string message)
        {
            ...
            Array.Copy(byteHeader, newByte, byteHeader.Length);
            Array.Copy(byteNumber, 0, newByte, byteHeader.Length, byteNumber.Length);
            Array.Copy(byteMessage, 0, newByte, byteHeader.Length + byteNumber.Length, byteMessage.Length);
